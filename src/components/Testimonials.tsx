...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    text: "ææΩΩΩΩPelayanan luar biasa! iPhone 15 Pro yang saya beli dalam kondisi sempurna. Proses checkout sangat mudah dan respon via WhatsApp sangat cepat. Pasti akan beli lagi!”
  },
  {
    id: 2,
    name: 'Siti Rahmawati',
